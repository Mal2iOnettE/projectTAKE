          ...
          return MaterialApp(
              ...
              theme: _setting.brightness.value == Brightness.light
                  ? ThemeData(
                      ...
                      accentColor: Color(0xFFd01f44),//config.Colors().mainColor(1),
                      ...
                      textTheme: TextTheme(
                        headline6: TextStyle(fontSize: 18.0, fontWeight: FontWeight.w700, color: Colors.white,height: 1.3),
                        ...
                        headline2: TextStyle(fontSize: 24.0, fontWeight: FontWeight.w700, color: Color(0xFFD01F44), height: 1.4),
