...
class Home2Widget extends StatefulWidget {
  ...
  Home2Widget({Key key, this.parentScaffoldKey, this.marketsList, this.reviewList}) : super(key: key);

  @override
  _Home2WidgetState createState() => _Home2WidgetState();
}

class _Home2WidgetState extends StateMVC<Home2Widget> {
  HomeController _con;

  _Home2WidgetState() : super(HomeController()) {
    _con = controller;
  }
